    ...
    onValue(logsRef, (snapshot) => {
        ...
        if (data) {
            ...
            logs.forEach(log => {
                ...
                li.innerHTML = `<span style="color:#4cd137">${log.victim}</span> acusó a <span style="color:#ff4757">${log.attacker}</span> <small style="color:#666">(${new Date(log.timestamp).toLocaleTimeString()})</small>`;
